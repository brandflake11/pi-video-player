...
then
    ...
    echo "mpv = sleep 10 && while true; do mpv --video-rotate=90 --fs --loop  /home/icat/Videos; done" >> "$WAYFIRE"
fi
...
echo "Set an Ethernet IP Address within the 192.168.2.4-255 range."
read -rp "Press enter to continue"
